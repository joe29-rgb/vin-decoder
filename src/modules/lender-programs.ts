...
const LENDER_PROGRAMS: Record<string, Record<string, LenderProgram>> = {
  ...
  Santander: {
    'Tier8': {
      ...
      rate: 11.49,
      ltv: 165,
      maxDsr: 50, // Max monthly payment: $1,500
      minIncome: 1800,
      reserve: 600,
      fee: 0,
    ...
    'Tier6': {
      ...
      rate: 16.49,
      ltv: 165,
      maxDsr: 50, // Max monthly payment: $950
      minIncome: 1800,
      reserve: 550,
      fee: 0,
    ...
    'Tier5': {
      ...
      rate: 21.99,
      ltv: 165,
      maxDsr: 50, // Max monthly payment: $850
      minIncome: 1800,
      reserve: 550,
      fee: 0,
    ...
    'Tier4': {
      ...
      rate: 24.49,
      ltv: 165,
      maxDsr: 50, // Max monthly payment: $750
      minIncome: 1800,
      reserve: 550,
      fee: 0,
      negativeEquityLimit: 3500,
    ...
    'Tier3': {
      ...
      rate: 26.24,
      ltv: 165,
      maxDsr: 50, // Max monthly payment: $700
      minIncome: 1800,
      reserve: 525,
      fee: 0,
    ...
    'Tier2': {
      ...
      rate: 29.99,
      ltv: 165,
      maxDsr: 50, // Max monthly payment: $650
      minIncome: 1800,
      reserve: 750,
      fee: 0,
      negativeEquityLimit: 3000,
 ...
 * SDA programs: Dynamic LTV - Star 5 (165% new/160% used), Star 4 (160% new/150% used)
...
export function getEffectiveLTV(
  ...
  const isTD = lenderNorm === 'TD';
  const isSDA = lenderNorm === 'SDA';
  const isNewVehicle = vehicleYear >= 2024 && vehicleYear <= 2026;
  
  // TD: 125% for new 2024-2026 vehicles
  if (isTD && isNewVehicle) {
    return 125;
  }
  
  // SDA: Dynamic LTV for Star 5 and Star 4
  if (isSDA) {
    const tierNorm = tier.toLowerCase();
    if (tierNorm.includes('star5') || tierNorm === 'star 5') {
      return isNewVehicle ? 165 : 160;
    }
    if (tierNorm.includes('star4') || tierNorm === 'star 4') {
      return isNewVehicle ? 160 : 150;
    }
  }
